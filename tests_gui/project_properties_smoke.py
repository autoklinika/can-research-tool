...
def main() -> None:
    ...
    with TemporaryDirectory() as temporary:
        ...
        try:
            ...
            fake_live.mode_combo.setCurrentIndex(
                fake_live.mode_combo.findData("bench")
            )
            window.navigator.widgets["live-capture"] = fake_live

            dialog = window.services.create_project_properties_dialog(
                window,
                project,
            )
            ...
            custom_dialog.description_edit.setPlainText(
                "Custom bitrate description"
            )
            window.services.create_project_properties_dialog = (
            ...
            for candidate in (failing_dialog, custom_dialog, dialog):
